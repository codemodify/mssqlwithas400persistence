            ...
            try
            {
                ...
                client.openConnection();
                {
                    List<Object>    arguments = new List<Object>();
                                    ...
                                    arguments.Add("0142142758");
                                    arguments.Add("0687523698");
                                    arguments.Add("0159863215");
                                    arguments.Add("LR");
                                    arguments.Add("N");
                                    arguments.Add("N");
                                    arguments.Add("05/12/1976");
                                    arguments.Add("1976");
                                    arguments.Add("27A14 bat B");
                                    arguments.Add("");
                                    arguments.Add("");
                                    arguments.Add("");

                    String commandToExecute = client.getDymanicSqlBuilder().buildExecProcQuery( "E_PGM.POCLCAPROS", ref arguments );
