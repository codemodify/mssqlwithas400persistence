            ...
            try
            {
                ...
                client.openConnection();
                {
                    List<Object>    arguments = new List<Object>();
                                    ...
                                    arguments.Add("Test de la saisie des observations pour la campagne d-appels sortants");

                    String commandToExecute = client.getDymanicSqlBuilder().buildExecProcQuery( "E_PGM.POCLCAOBS", ref arguments );
